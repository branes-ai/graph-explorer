...
void Scene_open_operation::execute(Explorer_context& context)
{
    ...
    if (!m_scene_root) {
        ...
        m_scene_root = std::make_shared<Scene_root>(
            ...
            *context.scene_message_bus,
            &context,
            context.explorer_message_bus,
            context.explorer_scenes, // registers into Explorer_scenes
            m_content_library,
        ...
        // Re-register
        m_scene_root->register_to_explorer_scenes(*context.explorer_scenes);
    }
}

void Scene_open_operation::undo(Explorer_context& context)
{
    ERHE_VERIFY(m_scene_root);
    context.explorer_scenes->unregister_scene_root(m_scene_root.get());
...
Asset_browser::Asset_browser(erhe::imgui::Imgui_renderer& imgui_renderer, erhe::imgui::Imgui_windows& imgui_windows, Explorer_context& explorer_context)
