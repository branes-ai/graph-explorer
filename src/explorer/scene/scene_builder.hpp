...
private:
    ...
    void make_brushes               (Explorer_settings& explorer_settings, Mesh_memory& mesh_memory, tf::Executor& executor);
    void make_platonic_solid_brushes(Explorer_settings& explorer_settings, Mesh_memory& mesh_memory);
    void make_sphere_brushes        (Explorer_settings& explorer_settings, Mesh_memory& mesh_memory);
    void make_torus_brushes         (Explorer_settings& explorer_settings, Mesh_memory& mesh_memory);
    void make_cylinder_brushes      (Explorer_settings& explorer_settings, Mesh_memory& mesh_memory);
    void make_cone_brushes          (Explorer_settings& explorer_settings, Mesh_memory& mesh_memory);
    void make_json_brushes          (Explorer_settings& explorer_settings, Mesh_memory& mesh_memory, tf::Taskflow* tf, Json_library& library);
