...
Undo_command::Undo_command(erhe::commands::Commands& commands, Explorer_context& context)
...
Redo_command::Redo_command(erhe::commands::Commands& commands, Explorer_context& context)
