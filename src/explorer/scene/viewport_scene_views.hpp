...
{
public:
    Open_new_viewport_scene_view_command(erhe::commands::Commands& commands, Explorer_context& editor_context);
...
{
public:
    Scene_views(erhe::commands::Commands& commands, Explorer_context& editor_context, Explorer_message_bus& editor_message_bus);
    ...
    auto create_viewport_scene_view(
        ...
        Explorer_rendering&                           editor_rendering,
