...
Transform_tool_drag_command::Transform_tool_drag_command(erhe::commands::Commands& commands, Explorer_context& explorer_context)
    ...
    , m_drag_enable_command         {commands, m_drag_redirect_update_command}
{
    ...
    //    [this, &explorer_context, &mesh_memory, &tools](){
    // TODO
    static_cast<void>(executor);
    shared.visualizations = std::make_unique<Handle_visualizations>(explorer_context, mesh_memory, tools);
...
void Transform_tool::on_message(Explorer_message& message)
{
