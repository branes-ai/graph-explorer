...
Physics_tool_drag_command::Physics_tool_drag_command(erhe::commands::Commands& commands, Explorer_context& context)
...
void Physics_tool::on_message(Explorer_message& message)
{
...
auto Physics_tool::on_drag() -> bool
{
    ...
    if (!m_context.explorer_settings->physics.dynamic_enable) {
        return false;
    }
