...
Create_new_camera_command::Create_new_camera_command(erhe::commands::Commands& commands, Explorer_context& context)
...
Create_new_empty_node_command::Create_new_empty_node_command(erhe::commands::Commands& commands, Explorer_context& context)
...
Create_new_light_command::Create_new_light_command(erhe::commands::Commands& commands, Explorer_context& context)
...
Create_new_rendertarget_command::Create_new_rendertarget_command(erhe::commands::Commands& commands, Explorer_context& context)
...
Scene_commands::Scene_commands(erhe::commands::Commands& commands, Explorer_context& explorer_context)
    : m_context                        {explorer_context}
    , m_create_new_camera_command      {commands, explorer_context}
    , m_create_new_empty_node_command  {commands, explorer_context}
    , m_create_new_light_command       {commands, explorer_context}
    , m_create_new_rendertarget_command{commands, explorer_context}
{
...
auto Scene_commands::create_new_rendertarget(erhe::scene::Node* parent) -> std::shared_ptr<Rendertarget_mesh>
{
    ...
    rendertarget_imgui_host->set_begin_callback(
        [this](erhe::imgui::Imgui_host& imgui_host) {
            m_context.explorer_windows->viewport_menu(imgui_host);
        }
    );
    ...
    std::shared_ptr<Viewport_scene_view> scene_view = m_context.scene_views->create_viewport_scene_view(
        *m_context.graphics_instance,
        *m_context.rendergraph,
        *m_context.explorer_rendering,
        *m_context.explorer_settings,
