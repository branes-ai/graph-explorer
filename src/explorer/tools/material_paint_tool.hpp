...
{
public:
    Material_paint_command(erhe::commands::Commands& commands, Explorer_context& context);
...
{
public:
    Material_pick_command(erhe::commands::Commands& commands, Explorer_context& context);
    void try_ready() override;
    auto try_call () -> bool override;
