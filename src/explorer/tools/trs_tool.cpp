...
void Trs_tool::declare_required_components()
{
    ...
    require<Explorer_message_bus>();
    require<Icon_set          >();
    m_explorer_scenes  = require<Explorer_scenes >();
...
void Trs_tool::initialize_component()
{
    ...
    get<Explorer_message_bus>()->add_receiver(
...
void Trs_tool::on_message(Explorer_message& message)
{
