...
void Explorer_settings::apply_limits(Explorer_message_bus& editor_message_bus)
{
    graphics.get_limits();
    read();
...
auto Explorer_settings::get_ui_scale() const -> float
{
...
void Graphics_settings::select_active_graphics_preset(Explorer_message_bus& editor_message_bus)
{
