...
Rendergraph_window::Rendergraph_window(erhe::imgui::Imgui_renderer& imgui_renderer, erhe::imgui::Imgui_windows& imgui_windows, Explorer_context& explorer_context)
...
void Rendergraph_window::imgui()
{
    ...
    const auto& scene_roots = m_explorer_scenes->get_scene_roots();
