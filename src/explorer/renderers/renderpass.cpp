...
void Renderpass::render(const Render_context& context) const
{
    ...
    const int64_t t0_ns  = context.explorer_context.time->get_host_system_time_ns();
    ...
    context.explorer_context.explorer_rendering->selection_outline->primitive_settings = erhe::scene_renderer::Primitive_interface_settings{
    ...
    if (this->mesh_layers.empty()) {
        ...
        context.explorer_context.forward_renderer->render_fullscreen(
            erhe::scene_renderer::Forward_renderer::Render_parameters{
                .index_buffer           = &context.explorer_context.mesh_memory->index_buffer,
                .vertex_buffer0         = &context.explorer_context.mesh_memory->position_vertex_buffer,
                .vertex_buffer1         = &context.explorer_context.mesh_memory->non_position_vertex_buffer,
                ...
                .error_shader_stages    = &context.explorer_context.programs->error.shader_stages,
        ...
        context.explorer_context.forward_renderer->render(
            erhe::scene_renderer::Forward_renderer::Render_parameters{
                .index_type             = context.explorer_context.mesh_memory->buffer_info.index_type,
                .index_buffer           = &context.explorer_context.mesh_memory->index_buffer,
                .vertex_buffer0         = &context.explorer_context.mesh_memory->position_vertex_buffer,
                .vertex_buffer1         = &context.explorer_context.mesh_memory->non_position_vertex_buffer,
                ...
                .override_shader_stages = this->allow_shader_stages_override ? context.override_shader_stages : nullptr,
                .error_shader_stages    = &context.explorer_context.programs->error.shader_stages,
                .debug_joint_indices    = context.explorer_context.explorer_rendering->debug_joint_indices,
                .debug_joint_colors     = context.explorer_context.explorer_rendering->debug_joint_colors,
                .debug_label            = get_name()
            }
        );
    }
