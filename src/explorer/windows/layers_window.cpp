...
Layers_window::Layers_window(erhe::imgui::Imgui_renderer& imgui_renderer, erhe::imgui::Imgui_windows& imgui_windows, Explorer_context& explorer_context)
...
void Layers_window::imgui()
{
    ...
    //m_context.explorer_scenes->imgui();
