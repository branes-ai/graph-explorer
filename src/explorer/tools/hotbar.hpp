...
{
public:
    Toggle_menu_visibility_command(erhe::commands::Commands& commands, Explorer_context& context);
...
{
public:
    Hotbar_trackpad_command(erhe::commands::Commands& commands, Explorer_context& context);
...
{
public:
    Hotbar_rotate_tool_command(erhe::commands::Commands& commands, Explorer_context& context, int rotate_direction);
    auto try_call() -> bool override;
...
{
public:
    Hotbar_thumbstick_command(erhe::commands::Commands& commands, Explorer_context& context);
    auto try_call_with_input(erhe::commands::Input_arguments& input) -> bool override;
