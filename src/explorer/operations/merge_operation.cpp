    ...
    : m_parameters{std::move(parameters)}
{
    ...
    if (!compound_shape_create_info.children.empty()) {
        ...
        if (parameters.context.explorer_settings->physics.static_enable) {
...
void Merge_operation::execute(Explorer_context& context)
{
...
void Merge_operation::undo(Explorer_context& context)
{
    ERHE_PROFILE_FUNCTION();
