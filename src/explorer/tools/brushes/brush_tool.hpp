...
{
public:
    Brush_tool_preview_command(erhe::commands::Commands& commands, Explorer_context& context);
...
{
public:
    Brush_tool_insert_command(erhe::commands::Commands& commands, Explorer_context& context);
...
{
public:
    Brush_tool_pick_command(erhe::commands::Commands& commands, Explorer_context& context);
...
private:
    void on_message                        (Explorer_message& explorer_message);
