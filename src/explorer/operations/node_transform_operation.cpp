...
//}
//
//void Node_operation::execute(Explorer_context&)
//{
...
//}
//
//void Node_operation::undo(Explorer_context&)
//{
...
void Node_transform_operation::execute(Explorer_context& context)
{
    log_operations->trace("Op Execute {}", describe());
...
void Node_transform_operation::undo(Explorer_context& context)
{
    log_operations->trace("Op Undo {}", describe());
