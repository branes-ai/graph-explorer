...
Material_paint_command::Material_paint_command(erhe::commands::Commands& commands, Explorer_context& context)
...
Material_pick_command::Material_pick_command(erhe::commands::Commands& commands, Explorer_context& context)
...
Material_paint_tool::Material_paint_tool(
    ...
    , m_paint_command{commands, explorer_context}
