...
Viewport_select_command::Viewport_select_command(erhe::commands::Commands& commands, Explorer_context& explorer_context)
...
Viewport_select_toggle_command::Viewport_select_toggle_command(erhe::commands::Commands& commands, Explorer_context& explorer_context)
...
Selection_delete_command::Selection_delete_command(erhe::commands::Commands& commands, Explorer_context& explorer_context)
...
Selection_cut_command::Selection_cut_command(erhe::commands::Commands& commands, Explorer_context& explorer_context)
...
Selection_copy_command::Selection_copy_command(erhe::commands::Commands& commands, Explorer_context& explorer_context)
...
Selection_duplicate_command::Selection_duplicate_command(erhe::commands::Commands& commands, Explorer_context& explorer_context)
...
void Selection::end_selection_change()
{
    ...
    Explorer_message selection_changed_message{
    ...
    m_context.explorer_message_bus->send_message(selection_changed_message);
}
...
void Selection::sanity_check()
{
    ...
    const auto& scene_roots = m_context.explorer_scenes->get_scene_roots();
