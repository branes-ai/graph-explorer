...
public:
    ...
    void select_active_graphics_preset(Explorer_message_bus& editor_message_bus);
...
{
public:
    explicit Explorer_settings();

    void apply_limits(Explorer_message_bus& editor_message_bus);
    void read        ();
    void write       ();
