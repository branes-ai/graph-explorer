...
#include "renderers/cube_renderer.hpp"
...
Forward_renderer::Forward_renderer(erhe::graphics::Instance& graphics_instance, erhe::scene_renderer::Program_interface& program_interface)
