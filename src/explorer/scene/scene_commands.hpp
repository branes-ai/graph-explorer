...
{
public:
    Create_new_camera_command(erhe::commands::Commands& commands, Explorer_context& context);
...
{
public:
    Create_new_empty_node_command(erhe::commands::Commands& commands, Explorer_context& context);
    auto try_call() -> bool override;
...
{
public:
    Create_new_light_command(erhe::commands::Commands& commands, Explorer_context& context);
    auto try_call() -> bool override;
...
{
public:
    Create_new_rendertarget_command(erhe::commands::Commands& commands, Explorer_context& context);
    auto try_call() -> bool override;
...
{
public:
    Scene_commands(erhe::commands::Commands& commands, Explorer_context& editor_context);
