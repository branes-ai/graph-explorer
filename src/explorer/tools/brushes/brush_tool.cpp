...
Brush_tool_preview_command::Brush_tool_preview_command(erhe::commands::Commands& commands, Explorer_context& context)
...
Brush_tool_insert_command::Brush_tool_insert_command(erhe::commands::Commands& commands, Explorer_context& context)
...
Brush_tool_pick_command::Brush_tool_pick_command(erhe::commands::Commands& commands, Explorer_context& context)
...
Brush_tool::Brush_tool(
    ...
    , m_preview_command               {commands, explorer_context}
    , m_insert_command                {commands, explorer_context}
    , m_pick_command                  {commands, explorer_context}
...
void Brush_tool::on_message(Explorer_message& message)
{
...
#if !defined(NDEBUG)
        m_context.explorer_scenes->sanity_check();
#endif
