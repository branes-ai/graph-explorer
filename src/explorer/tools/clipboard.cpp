...
Clipboard_paste_command::Clipboard_paste_command(erhe::commands::Commands& commands, Explorer_context& context)
...
Clipboard::Clipboard(erhe::commands::Commands& commands, Explorer_context& context, Explorer_message_bus& explorer_message_bus)
...
void Clipboard::on_message(Explorer_message& message)
{
