...
Fly_camera_turn_command::Fly_camera_turn_command(erhe::commands::Commands& commands, Explorer_context& context)
...
Fly_camera_tumble_command::Fly_camera_tumble_command(erhe::commands::Commands& commands, Explorer_context& context)
...
Fly_camera_track_command::Fly_camera_track_command(erhe::commands::Commands& commands, Explorer_context& context)
...
Fly_camera_zoom_command::Fly_camera_zoom_command(erhe::commands::Commands& commands, Explorer_context& context)
...
Fly_camera_frame_command::Fly_camera_frame_command(erhe::commands::Commands& commands, Explorer_context& context)
...
Fly_camera_serialization_command::Fly_camera_serialization_command(erhe::commands::Commands& commands, Explorer_context& context, bool store)
...
Fly_camera_tool::Fly_camera_tool(
    ...
    , m_turn_command                  {commands, explorer_context}
    , m_tumble_command                {commands, explorer_context}
    , m_track_command                 {commands, explorer_context}
    , m_zoom_command                  {commands, explorer_context}
    , m_frame_command                 {commands, explorer_context}
    , m_move_up_active_command        {commands, explorer_context, Variable::translate_y, erhe::math::Input_axis_control::more, true }
    , m_move_up_inactive_command      {commands, explorer_context, Variable::translate_y, erhe::math::Input_axis_control::more, false}
    , m_move_down_active_command      {commands, explorer_context, Variable::translate_y, erhe::math::Input_axis_control::less, true }
    , m_move_down_inactive_command    {commands, explorer_context, Variable::translate_y, erhe::math::Input_axis_control::less, false}
    , m_move_left_active_command      {commands, explorer_context, Variable::translate_x, erhe::math::Input_axis_control::less, true }
    , m_move_left_inactive_command    {commands, explorer_context, Variable::translate_x, erhe::math::Input_axis_control::less, false}
    , m_move_right_active_command     {commands, explorer_context, Variable::translate_x, erhe::math::Input_axis_control::more, true }
    , m_move_right_inactive_command   {commands, explorer_context, Variable::translate_x, erhe::math::Input_axis_control::more, false}
    , m_move_forward_active_command   {commands, explorer_context, Variable::translate_z, erhe::math::Input_axis_control::less, true }
    , m_move_forward_inactive_command {commands, explorer_context, Variable::translate_z, erhe::math::Input_axis_control::less, false}
    , m_move_backward_active_command  {commands, explorer_context, Variable::translate_z, erhe::math::Input_axis_control::more, true }
    , m_move_backward_inactive_command{commands, explorer_context, Variable::translate_z, erhe::math::Input_axis_control::more, false}
