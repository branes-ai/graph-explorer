...
Toggle_menu_visibility_command::Toggle_menu_visibility_command(erhe::commands::Commands& commands, Explorer_context& context)
...
Hotbar_trackpad_command::Hotbar_trackpad_command(erhe::commands::Commands& commands, Explorer_context& context)
...
Hotbar_thumbstick_command::Hotbar_thumbstick_command(erhe::commands::Commands& commands, Explorer_context& context)
...
Hotbar_rotate_tool_command::Hotbar_rotate_tool_command(erhe::commands::Commands& commands, Explorer_context& context, int rotate_direction)
...
Hotbar::Hotbar(
    ...
    , m_toggle_visibility_command{commands, explorer_context}
    , m_prev_tool_command        {commands, explorer_context, -1}
    , m_next_tool_command        {commands, explorer_context, 1}
#if defined(ERHE_XR_LIBRARY_OPENXR)
    , m_trackpad_command         {commands, explorer_context}
    , m_trackpad_click_command   {commands, m_trackpad_command}
    , m_thumbstick_command       {commands, explorer_context}
#endif
{
...
void Hotbar::init_hotbar()
{
    ...
    m_rendertarget_imgui_host = std::make_shared<explorer::Rendertarget_imgui_host>(
...
void Hotbar::on_message(Explorer_message& message)
{
