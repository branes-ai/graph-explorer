...
{
public:
    Fly_camera_turn_command(erhe::commands::Commands& commands, Explorer_context& context);
...
{
public:
    Fly_camera_tumble_command(erhe::commands::Commands& commands, Explorer_context& context);
    void try_ready          () override;
    auto try_call_with_input(erhe::commands::Input_arguments& input) -> bool override;
    void on_inactive        () override;
...
{
public:
    Fly_camera_track_command(erhe::commands::Commands& commands, Explorer_context& context);
    void try_ready() override;
...
{
public:
    Fly_camera_zoom_command(erhe::commands::Commands& commands, Explorer_context& context);
    void try_ready          () override;
    auto try_call_with_input(erhe::commands::Input_arguments& input) -> bool override;
...
{
public:
    Fly_camera_frame_command(erhe::commands::Commands& commands, Explorer_context& context);
    auto try_call() -> bool override;
...
{
public:
    Fly_camera_serialization_command(erhe::commands::Commands& commands, Explorer_context& context, bool store);
