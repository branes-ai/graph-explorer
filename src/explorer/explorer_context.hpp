...
public:
    ...
    Explorer_message_bus*                   explorer_message_bus  {nullptr};
    Explorer_rendering*                     explorer_rendering    {nullptr};
    Explorer_scenes*                        explorer_scenes       {nullptr};
    ...
    Hud*                                    hud                           {nullptr};
    Icon_browser*                           icon_browser                  {nullptr};
