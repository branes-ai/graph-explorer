...
public:
    ...
    void register_to_explorer_scenes    (Explorer_scenes& explorer_scenes);
    void unregister_from_explorer_scenes(Explorer_scenes& explorer_scenes);
...
private:
    ...
    Explorer_scenes*                                m_explorer_scenes{nullptr};
