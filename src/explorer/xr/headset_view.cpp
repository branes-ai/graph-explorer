...
Headset_view::Headset_view(
    ...
    : Scene_view               {explorer_context, Viewport_config::default_config()}
    ...
    , m_explorer_context         {explorer_context}
    ...
    , m_headset                {headset}
{
    ...
    m_shadow_render_node = explorer_rendering.create_shadow_node_for_scene_view(graphics_instance, rendergraph, explorer_settings, *this);
...
void Headset_view::imgui()
{
    ...
    const bool combo_used = m_explorer_context.explorer_scenes->scene_combo("##Scene", scene_root_raw, false);
    if (combo_used) {
    ...
    if (frame_timing.should_render) {
        ...
        auto callback = [this, &first_view](erhe::xr::Render_view& render_view) -> bool {
            ...
            if (render) {
                ...
                m_context.explorer_rendering->render_composer(render_context);
                m_context.line_renderer   ->open();
                m_context.tools           ->render_viewport_tools(render_context);
                m_context.explorer_rendering->render_viewport_renderables(render_context);
